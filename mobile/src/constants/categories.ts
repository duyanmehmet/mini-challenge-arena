...
export const CATEGORIES: CategoryConfig[] = [
  ...
  { id: 'medical',   name: 'Tıbbi Terimler', shortName: 'Tıp',     icon: '🩺', color: '#e74c3c', group: 'special',  description: 'Hastalık adları, organ isimleri ve tıp terimleri.',                   questionCount: 200 },
